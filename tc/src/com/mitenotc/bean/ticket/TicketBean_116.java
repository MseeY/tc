 ...
 *
 */
public class TicketBean_116 extends TicketBean{
	...
	public String formatLotteryNums() {
		return formatLotteryNums_fc3d();
	}
	@Override
	public String showLotteryNums() {
		return showLotteryNums_fc3d();
	}
	/**
	 * 排列三 号码 格式化到 网络协议要求的格式
	 * @return
	 */
	protected String formatLotteryNums_fc3d() {//该网络的字符串 和 界面中显示的字符串的格式的唯一区别是分隔符不同
		formatStr = "";
	 ...
	 * @return
	 */
	protected String showLotteryNums_fc3d() {//该网络的字符串 和 界面中显示的字符串的格式的唯一区别是分隔符不同
		showStr = "";
