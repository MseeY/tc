...
public class D209Dialog extends Dialog implements android.view.View.OnClickListener {
    private Context ctx;
    private CheckboxGroup cb_gp;
	public D209Dialog(Context context) {
		super(context, R.style.dialog_theme);
		ctx=context;
		init();
	}
	public D209Dialog(Context context, int theme) {
		super(context, theme);
		ctx=context;
	...
	private void init() {
		setContentView(R.layout.d209dialog_layout);
		initView();
	}
	...
	public View getView(){
		return View.inflate(ctx, R.layout.d209dialog_layout, null);
	}
	@Override
