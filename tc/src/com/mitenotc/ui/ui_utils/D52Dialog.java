...
public class D52Dialog extends Dialog implements android.view.View.OnClickListener {
    private Context ctx;
    private CheckboxGroup cb_gp;
	public D52Dialog(Context context) {
		super(context, R.style.dialog_theme);
		ctx=context;
		init();
	}
	public D52Dialog(Context context, int theme) {
		super(context, theme);
		ctx=context;
	...
	public void onClick(View v) {
		...
		case R.id.affirm_btn:// 确认
			...
			System.out.println("124----d52-----tag------>"+s.toString());
			List<String> s2=cb_gp.getTextList();
			System.out.println("124----d52----Text------->"+s2.toString().trim());
			cancel();
			break;
		}
