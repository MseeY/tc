 ...
 *
 */
@BaseBuyAnnotation(lotteryId = "130",salesType = "0",childId="2")
public class PL130 extends BaseBuyFragment implements RefreshYiLou {
...
//	private int nextIssue=00;  // 下一期期号
	...
	private void registerBroadcastReceiver()
	{
        if(mLouReceiver==null){
        	mLouReceiver =new RefreshYiLouReceiver("112"); 
        	mLouReceiver.setmRefreshYiLou(this);
        	IntentFilter mFilter=new IntentFilter();
        	mFilter.addAction("com.mitenotc.ui.play.on_lottery_"+112+"_start_loading");
        	mFilter.addAction("com.mitenotc.ui.play.on_lottery_"+112+"_stop_loading");
        	mFilter.addAction("com.mitenotc.ui.play.on_lottery_"+112+"_awardinfo_received");
	...
	public void onStop() 
   {
	...
	@Override
	protected void onMessageReceived(Message msg) {////System.out.println("onmessage received cmd = "+msg.arg2);
		            ...
		            if("0".equals(mBean.getA())){
			               ...
			               }else 
			               {
							...
							//      		 F	百位遗漏值
											...
											System.out.println("130--je1-->"+je1.toString());
											System.out.println("130--je2-->"+je1.toString());
											System.out.println("130--je3-->"+je1.toString());
...
//	}
	...
	protected void onSaleTypeChanged(String tag)
   {
	...
	private void initSaleType_2() 
	{
		...
		changeTwoTVmsg("选号","2","6积分");//改变TextView 对应的text
	...
	private void initSaleType_3() {
		...
		changeTwoTVmsg("选号","3","19积分");//改变TextView 对应的text
		notice_linearLayout.setVisibility(View.GONE);//隐藏万位选号上的提示
		//把相应的saleType的 selectBalls 数据添加到 ticket 中
		reloadLotteryNums(0);
	...
	private void initSaleType_4() {
		...
		//显示摇一摇条目,同时改变 摇一摇传感器的 开和关
		changeShakeVisibility(true);
		changeTwoTVmsg("选号","4","78积分");//改变TextView 对应的text
	...
	private void initSaleType_5() {
		...
		//显示摇一摇条目,同时改变 摇一摇传感器的 开和关
		changeShakeVisibility(true);
		changeTwoTVmsg("选号","5","540积分");//改变TextView 对应的text
		notice_linearLayout.setVisibility(View.GONE);//隐藏万位选号上的提示
	...
	private void initSaleType_6() {
		...
		changeTwoTVmsg("选号","5","90积分");//改变TextView 对应的text
	...
	private void initSaleType_7() {
		...
		goneRL();
		changeTwoTVmsg("选号","5","26积分");//改变TextView 对应的text
	...
	private void initSaleType_8() {
		...
		goneRL();
		changeTwoTVmsg("选号","5","9积分");//改变TextView 对应的text
	...
	private void initSaleType_1() {
		...
		changeTwoTVmsg1("选号","1","13积分");//改变TextView 对应的text
	...
	private void initSaleType_39() {
		...
		redstr = extracted("与开奖前2位一一对应即奖", "130积分");
		elevenC5_show_bonus_tv.setText(redstr);
	...
	private void initSaleType_11() {
	    ...
	    redstr = extracted("与开奖前2位顺序不限即奖" , "65积分");
		elevenC5_show_bonus_tv.setText(redstr);
	...
	private void initSaleType_310() {
		...
		cancelMutualContainers();//取消容器互斥
		visibleRL();
		redstr = extracted("与开奖前3位一一对应即奖" , "1170积分");
		elevenC5_show_bonus_tv.setText(redstr);
...
//		        +"</font></font color=#ff0000>"+"195积分"+"</font>");
		 redstr = extracted("猜中开奖前3位顺序不限即奖" , "195积分");
		elevenC5_show_bonus_tv.setText(redstr);
		elevenC5_one_tv.setText("选号");//万位选号
	...
	private void initSaleType_22() {
		...
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		 redstr = extracted("猜中开奖的任意2个号即奖" , "6积分");
		elevenC5_show_bonus_tv.setText(redstr);
//				Html.fromHtml("<font color=#606060>"+"猜中开奖的任意2个号即奖"
//				        +"</font></font color=#ff0000>"+"6积分"+"</font>"));
//		小字提示
...
//		选号左边提示
	...
	private void initSaleType_23() {
		...
		elevenC5_three_RL.setVisibility(View.GONE);//百位布局
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		redstr = extracted("猜中开奖的任意3个号即奖", "19积分");
		elevenC5_show_bonus_tv.setText(redstr);
//				Html.fromHtml("<font color=#606060>"+"猜中开奖的任意3个号即奖"
//				        +"</font></font color=#ff0000>"+"19积分"+"</font>"));
//		小字提示
	...
	private void initSaleType_24() {
		...
		elevenC5_three_RL.setVisibility(View.GONE);//百位布局
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		redstr = extracted("猜中开奖的任意4个号即奖", "78积分");
		elevenC5_show_bonus_tv.setText(redstr);
//				Html.fromHtml("<font color=#606060>"+"猜中开奖的任意4个号即奖"
//				        +"</font></font color=#ff0000>"+"78积分"+"</font>"));
		elevenC5_one_tv.setText("胆码");//万位
		elevenC5_two_tv.setText("拖码");//千位
//		小字提示
	...
	private void initSaleType_25() {
		...
		elevenC5_three_RL.setVisibility(View.GONE);//百位布局
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		redstr = extracted("猜中开奖的任意5个号即奖", "540积分");
		elevenC5_show_bonus_tv.setText(redstr);
//				Html.fromHtml("<font color=#606060>"+"猜中开奖的任意5个号即奖"
//				        +"</font></font color=#ff0000>"+"540积分"+"</font>"));
		elevenC5_one_tv.setText("胆码");//万位
		elevenC5_two_tv.setText("拖码");//千位
//		小字提示
	...
	private void initSaleType_26() {
		...
		elevenC5_three_RL.setVisibility(View.GONE);//百位布局
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		redstr = extracted("猜中开奖的全部5个号即奖", "90积分");
		elevenC5_show_bonus_tv.setText(redstr);
//				Html.fromHtml("<font color=#606060>"+"猜中开奖的全部5个号即奖"
//				        +"</font></font color=#ff0000>"+"90积分"+"</font>"));
		elevenC5_one_tv.setText("胆码");//万位
		elevenC5_two_tv.setText("拖码");//千位
//		小字提示
	...
	private void initSaleType_27() {
		...
		elevenC5_three_RL.setVisibility(View.GONE);//百位布局
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		 redstr = extracted("猜中开奖的全部5个号即奖", "26积分");
		elevenC5_show_bonus_tv.setText(redstr);
//				Html.fromHtml("<font color=#606060>"+"猜中开奖的全部5个号即奖"
//				        +"</font></font color=#ff0000>"+"26积分"+"</font>"));
		elevenC5_one_tv.setText("胆码");//万位
		elevenC5_two_tv.setText("拖码");//千位
...
//		小字提示
	...
	private void initSaleType_211() {
		...
		elevenC5_three_RL.setVisibility(View.GONE);//百位布局
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		 redstr = extracted("猜中开奖的前2位顺序不限即奖", "65积分");
		elevenC5_show_bonus_tv.setText(redstr);
//				Html.fromHtml("<font color=#606060>"+"猜中开奖的前2位顺序不限即奖"
//				        +"</font></font color=#ff0000>"+"65积分"+"</font>"));
		elevenC5_one_tv.setText("胆码");//万位
		elevenC5_two_tv.setText("拖码");//千位
//		小字提示
		elevenC5_Iguess1_tv.setText("请选择1个");
	...
	private void initSaleType_212() 
	{
		...
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		redstr = extracted("猜中开奖的前3位顺序不限即奖", "195积分");
		elevenC5_show_bonus_tv.setText(redstr);
...
//		小字提示
	...
	public void onReceiveYilou_stop() {
		...
		String issueStr=CustomTagEnum.lottery_11x5.getIssue();
	...
	@Override
	public void onReceiveYilou_awardinfo() {////System.out.println("11x5 遗漏更新");
