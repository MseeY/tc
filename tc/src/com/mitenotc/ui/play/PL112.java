 ...
 *
 */
@BaseBuyAnnotation(lotteryId = "112",salesType = "0",childId="2")
public class PL112 extends BaseBuyFragment implements RefreshYiLou {
...
//	}
	...
	protected void onSaleTypeChanged(String tag)
   {
		...
		tag="1"+tag.replace(",", "");// 字符串前面+1  为了更好的标识，之前有bug
	...
	private void initSaleType_6() {
		...
		changeTwoTVmsg("选号","5","90元");//改变TextView 对应的text
	...
	private void initSaleType_7() {
		...
		goneRL();
		changeTwoTVmsg("选号","5","26元");//改变TextView 对应的text
	...
	private void initSaleType_8() {
		...
		goneRL();
		changeTwoTVmsg("选号","5","9元");//改变TextView 对应的text
...
//		小字提示
	...
	private void initSaleType_26() {
		...
		elevenC5_three_RL.setVisibility(View.GONE);//百位布局
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		redstr = extracted("猜中开奖的全部5个号即奖", "90元");
		elevenC5_show_bonus_tv.setText(redstr);
...
//		小字提示
	...
	private void initSaleType_27() {
		...
		elevenC5_three_RL.setVisibility(View.GONE);//百位布局
		elevenC5_two_RL.setVisibility(View.VISIBLE);//千位布局VISIBLE
		 redstr = extracted("猜中开奖的全部5个号即奖", "26元");
		elevenC5_show_bonus_tv.setText(redstr);
//				Html.fromHtml("<font color=#606060>"+"猜中开奖的全部5个号即奖"
