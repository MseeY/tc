...
public class Cache_1201 implements BaseCache {
...
//			Cursor result= db.rawQuery("select validtime,responsestr from mitenotc_cache where cmd=? and requeststr=?", selectionArgs);
			...
			if(result.getCount()>0)
		    {
		    	...
		    	////System.out.println("1201=====>setCache===update:"+hashkey);
		    }else
		    {
		    	//insert 
		    	 ContentValues cv = new ContentValues();
		    	 ...
		    	 ////System.out.println("1201=====>setCache===insert:"+hashkey);
	...
	{	
		////System.out.println("1201=====>getCache===Q:");
		String hashkey = "";
		...
		if(db == null)
			return null;
		////System.out.println("1201=====>getCache===Q:"+hashkey);
		String[] selectionArgs={String.valueOf(cmd),hashkey};
	    ...
	    while (!result.isAfterLast()) 
	    {
	      ...
	      result.close();
	      ////System.out.println("1201=====>getCache===Q:"+responsestr);
	    if(responsestr == null)
	    			return null;
		else
			try {
